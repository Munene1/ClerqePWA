...
export default function MessageBubble({
  ...
  const bubbleClass =
    message.kind === "error"
      ...
      : mine
        ? "rounded-[6px] bg-[var(--brand-primary-soft)] px-2.5 py-[7px] text-gray-900 dark:bg-[#0f2623] dark:text-gray-100"
        ...
        <div className={`flex ${mine ? "justify-end" : ""} items-center gap-2`}>
          ...
          <div className={bubbleClass}>
            {message.kind === "assistant_pending" ? (
              ...
              <p className="whitespace-pre-wrap text-[15px] leading-6">{displayText}</p>
            ) : (
